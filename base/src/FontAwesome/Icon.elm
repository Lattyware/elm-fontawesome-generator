...
@docs IconDefinition, present

-}

import FontAwesome.Icon.Internal as Internal exposing (Icon(..), WithId, WithoutId)
...
You will find these in the modules for the different IconDefinition packs (e.g: `FontAwesome.Solid.Definition`).
...
-}
present : IconDefinition -> Icon WithoutId
present icon =
    Icon
        { icon = icon
        , transforms = []
...
-}
updateInternalIcon : IconDefinition -> Internal.IconDefinition
