...
import FontAwesome.Icon.Internal as Icon exposing (Icon(..), IconDefinition, WithId)
...
viewPaths : List (Svg.Attribute msg) -> IconDefinition -> Svg msg
...
viewWithTransform : String -> SvgTransformStyles msg -> IconDefinition -> Svg msg
...
viewMaskedWithTransform : String -> SvgTransformStyles msg -> IconDefinition -> Icon WithId -> Svg msg
